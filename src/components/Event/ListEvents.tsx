...
export const ListEvents = () => {
  ...
  const swipeNavigation = useTagSwipeNavigation({
    activeTagId,
    tags,
  ...
  return (
    <div className="grid gap-2" aria-busy={tagLoading}>
      <div className="grid touch-pan-y gap-2" {...swipeNavigation}>
        ...
        >
          ...
          >
            <div className="grid min-h-24 grid-cols-1 content-start gap-2">
              {events.map((event) => (
